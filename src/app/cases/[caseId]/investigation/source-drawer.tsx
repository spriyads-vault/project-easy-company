      ...
      >
        <div className="flex items-start justify-between gap-3">
          ...
          <button
            ...
            type="button"
            onClick={onClose}
            className="shrink-0 border border-[#ddd7c8] px-2 py-1 text-xs uppercase tracking-wide hover:border-[#1f9d52]/60 hover:text-[#177a3f]"
          >
            Close
          </button>
        </div>
        ...
        <div className={`flex flex-col gap-2 border-t border-b border-[#e7e2d6] py-4`}>
