    ...
    >
      ...
      {shownDetail.length > 0 ? (
        <details className="group">
          <summary
            className={`cursor-pointer list-none text-xs ${text.muted} hover:text-[#18181b]`}
          >
          ...
          <dl className="mt-3 grid grid-cols-2 gap-x-4 gap-y-3 border-t border-[#ececee] pt-3 sm:grid-cols-3 lg:grid-cols-4">
