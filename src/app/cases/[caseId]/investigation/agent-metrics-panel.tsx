    ...
    >
      ...
      {shownDetail.length > 0 ? (
        <details className="group">
          <summary
            className={`cursor-pointer list-none text-xs ${text.muted} hover:text-[#f5f6f7]`}
          >
          ...
          <dl className="mt-3 grid grid-cols-2 gap-x-4 gap-y-3 border-t border-[#1c212a] pt-3 sm:grid-cols-3 lg:grid-cols-4">
